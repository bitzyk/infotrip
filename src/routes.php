...
$app->post('/admin-root/agoda/import-hotels-process', \Infotrip\Handler\Action\Agoda\AdminRootAgodaImportHotelsProcess::class)->setName('adminRootAgodaImportHotelsProcess');
